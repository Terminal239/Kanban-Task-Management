...
export const Auth = () => {
  ...
  const TwoFactorUI = () => (
    <div className="flex flex-col items-center gap-4 text-white">
      <p className="text-center text-lg leading-6 text-white">Please enter the 6-digit code generated by your authentication app.</p>
      <div className="flex justify-center gap-4">
        {twoFactorCode.map((digit, index) => (
          <input
            key={index}
            ref={(el) => (inputRefs.current[index] = el)}
            className={`h-20 w-12 rounded bg-magenta-800 p-2 text-center text-2xl text-white shadow-inner ${twoFactorError ? "border-2 border-red-400" : ""}`}
  ...
  const VertificationUI = () => (
    <div className="flex flex-col items-center gap-4 text-white">
      ...
      <div className="mt-4 flex flex-col gap-2">
        ...
        {!isEmailResent ? (
          <Button handleClick={resendVerificationEmail} type="text" className="text-center text-white dark:text-center">
